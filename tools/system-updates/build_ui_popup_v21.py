...
VERSION = "2026.08.03.21"
root = Path.cwd()
component_root = root / "tools" / "ui-popup-v21"

components: dict[str, bytes] = {
    "css": (component_root / "popup-fix.css").read_bytes(),
}
...
installer = installer.replace("__UI_POPUP_FIX_VERSION__", VERSION)
installer = installer.replace("__UI_POPUP_FIX_PAYLOAD_B64__", payload_b64)
installer = installer.replace("__UI_POPUP_FIX_PAYLOAD_SHA__", payload_sha)
